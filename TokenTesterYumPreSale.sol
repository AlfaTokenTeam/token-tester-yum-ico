...
import "./TokenTesterYum.sol";

contract TokenTesterYumPreSale {
    TokenTesterYum public token;
    ...
    function TokenTesterYumPreSale(
        TokenTesterYum _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = TokenTesterYum(_token);
